...
def transform_table(input_excel_path, output_csv_path):
    ...
    for _, row in df.iterrows():
        patient_id = row['MHA Anon Patient ID']
        print(patient_id)
...
# Example usage:
input_excel_path = '/home/jeff/Downloads/ODELIA_Paper_MHA_Simplified_Sample.xlsx'
output_csv_path = '/home/jeff/Downloads/out_put.csv'
