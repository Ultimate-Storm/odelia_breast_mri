...
binary = task == "binary"
ds_train = ODELIA_Dataset3D(split='train', institutions='UKA', binary=binary, config=config, labels=label)
...
dm = DataModule(ds_train=ds_train, batch_size=1, num_workers=0)
